...
public class ChordSpellingTutorController extends TutorController
{
    ...
    ChordSpellingOptionController optionController;
    ChordSpellingAnswerController answerController;
    
    public ChordSpellingTutorController() {
    ...
    public void initialize(final OuterTemplateController outerController, final Environment tutorEnvironment) throws IOException {
        ...
        tutorOptionsLoader.setLocation(this.getClass().getResource("/View/Tutors/ChordSpellingTutor/chordSpellingTutorOptions.fxml"));
        this.tutorOptionsAnchorPane = (AnchorPane)tutorOptionsLoader.load();
        this.tutorPane.add((Node)this.tutorOptionsAnchorPane, 0, 0);
        this.optionController = (ChordSpellingOptionController)tutorOptionsLoader.getController();
        final FXMLLoader tutorAnswersLoader = new FXMLLoader();
        tutorAnswersLoader.setLocation(this.getClass().getResource("/View/Tutors/ChordSpellingTutor/chordSpellingTutorAnswers.fxml"));
        this.tutorAnswersAnchorPane = (AnchorPane)tutorAnswersLoader.load();
        this.answerController = (ChordSpellingAnswerController)tutorAnswersLoader.getController();
