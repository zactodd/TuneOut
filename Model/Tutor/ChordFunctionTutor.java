...
public class ChordFunctionTutor extends Tutor
{
    ...
    private Question getFunctionQuestion() {
        ...
        final Note keyNoteObj = notes.get(Tutor.randInt(0, notes.size() - 1));
        ...
        String answer;
        do {
            final int num = Tutor.randInt(0, possibleChords.size() - 1);
    ...
    private String getRandomNonFunctionalChord(final String keyNote) {
        ...
        String[] theChord;
        do {
            final int num = Tutor.randInt(0, allChordsForKey.size() - 1);
    ...
    private Question getChordQuestion() {
        ...
        String answer;
        do {
            final String keyNote = NoteMap.getNoteString(Tutor.randInt(60, 71));
            final String keyNoteNoOctave = (keyNote != null) ? keyNote.replaceAll("\\d", "") : null;
            final int num = Tutor.randInt(0, ChordMap.getAllFunctionNames().size() - 1);
