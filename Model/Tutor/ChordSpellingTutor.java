...
public class ChordSpellingTutor extends Tutor
{
    ...
    public void generateQuestion() {
        ...
        if (this.currentQuestionNumber <= this.numQuestions && !this.questions.containsKey(this.currentQuestionNumber)) {
            ...
            if (this.options.getSpellingQuestion()) {
                if (this.options.allowsRandomNotes() && Tutor.randInt(0, ChordSpellingTutor.PERCENTAGE) <= ChordSpellingTutor.RANDOM_CHORD_PERECENTAGE) {
    ...
    private Question getChordQuestion() {
        ...
        do {
            ...
            if (Tutor.randInt(0, ChordSpellingTutor.PERCENTAGE) <= ChordSpellingTutor.INVERSION_PERCENTAGE) {
                final Integer inversionDegree = Tutor.randInt(1, chord.size() - 1);
    ...
    private List<Note> getRandomChord() {
        final Note rootNote = ChordSpellingTutor.NOTES.get(Tutor.randInt(0, ChordSpellingTutor.NOTES.size() - 1));
        ...
        do {
            Integer randNum = Tutor.randInt(0, chordTypes.size() - 1);
    ...
    private Question randomNotesQuestion() {
        ...
        do {
            ...
            do {
                ...
                for (Integer numOfNotes = Tutor.randInt(ChordSpellingTutor.MIN_NUM_NOTE, ChordSpellingTutor.MAX_NUM_NOTE), i = 0; i < numOfNotes; ++i) {
                    chord.add(ChordSpellingTutor.NOTES.get(Tutor.randInt(0, ChordSpellingTutor.NOTES.size() - 1)));
                }
