...
public class KeySignatureTutor extends Tutor
{
    ...
    private Integer assignQuestionType() {
        ...
        Label_0629: {
            switch (n) {
                case 0: {
                    final int randomInt = Tutor.randInt(0, 1);
                    ...
                    switch (keySignatureOption) {
                        ...
                        case "-c": {
                            whichQuesType = Tutor.randInt(1, 4);
                            break;
                        }
                    }
                    break;
                ...
                case 1: {
                    ...
                    switch (keySignatureOption2) {
                        ...
                        case "-c": {
                            whichQuesType = Tutor.randInt(1, 2);
                            break;
                        }
                    }
                    break;
                ...
                case 2: {
                    ...
                    switch (keySignatureOption3) {
                        ...
                        case "-c": {
                            whichQuesType = Tutor.randInt(3, 4);
                            break Label_0629;
                        }
                    }
                    break;
    ...
    private Question nextQuestion() {
        ...
        do {
            final int randomKeySigIndex = Tutor.randInt(0, allKeySignatures.size() - 1);
