...
public class ParentOfCommand extends Command
{
    ...
    public ParentOfCommand(final List<String> arg) {
        ...
        if (arg.size() == this.paraCount) {
            ...
            final String inputNote = Command.translate("C4", arg.get(this.notePos));
            ...
            if (parentScale == null) {
                ...
                if (ionianRootNote == null) {
                    ...
                    final String translatedNote = Command.translate(arg.get(this.notePos), ionianRootNote.getNoteWithOctave());
