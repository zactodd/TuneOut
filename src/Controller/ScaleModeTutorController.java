...
public class ScaleModeTutorController extends TutorController
{
    private OuterTemplateController main;
    ScaleModeOptionController optionController;
    ScaleModeAnswerController answerController;
    
    public ScaleModeTutorController() {
    ...
    public void initialize(final OuterTemplateController outerController, final Environment tutorEnvironment) throws IOException {
        ...
        tutorOptionsLoader.setLocation(this.getClass().getResource("/View/Tutors/ScaleModeTutor/scaleModeTutorOptions.fxml"));
        this.tutorOptionsAnchorPane = (AnchorPane)tutorOptionsLoader.load();
        this.tutorPane.add((Node)this.tutorOptionsAnchorPane, 0, 0);
        this.optionController = (ScaleModeOptionController)tutorOptionsLoader.getController();
        final FXMLLoader tutorAnswersLoader = new FXMLLoader();
        tutorAnswersLoader.setLocation(this.getClass().getResource("/View/Tutors/ScaleModeTutor/scaleModeTutorAnswers.fxml"));
        this.tutorAnswersAnchorPane = (AnchorPane)tutorAnswersLoader.load();
        this.answerController = (ScaleModeAnswerController)tutorAnswersLoader.getController();
