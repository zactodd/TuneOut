...
public class PitchTutor extends Tutor
{
    ...
    public void generateQuestion() {
        ...
        if (this.currentQuestionNumber <= this.numQuestions && !this.questions.containsKey(this.currentQuestionNumber)) {
            ...
            do {
                currentQuestion.firstRandomNote = randInt(this.pitchRangeMinMidi, this.pitchRangeMaxMidi);
                currentQuestion.secondRandomNote = randInt(this.pitchRangeMinMidi, this.pitchRangeMaxMidi);
